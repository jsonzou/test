package com.test.core.mybatis.plugin.paging;
...
import com.test.core.commons.utils.ReflectUtil;
import com.test.core.commons.utils.StringUti;
import com.test.core.mybatis.plugin.paging.dialect.Dialect;
...
public class PagingPlugin implements Interceptor{
    private static final Log logger = LogFactory.getLog(PagingPlugin.class);
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if(StringUti.isEmpty(dialectClass)){
