...
public class ReflectUtil{
    ...
    public void addProperty(){
    	...
    	generator.addProperty("name", ReflectUtil.class);
    ...
    public static <T> T newInstance(Class<T> c, Object...args ) throws SecurityException, NoSuchMethodException {
    
    	Class[] cs=new Class[args.length]; 
    	for (int i=0;i<cs.length;i++) {
			cs[i]=args[i].getClass();
		}
       Constructor<T> ct=c.getConstructor(cs);
       return BeanUtils.instantiateClass(ct, args);
    }
