package com.test.core.commons.utils.image;
...
public class ImageScaleImpl implements ImageScale {
	...
	public static void main(String args[]){
		...
		ImageScaleImpl test = new ImageScaleImpl();
		File f=new File("C:\\Users\\Administrator\\Pictures/12.gif");
		File f2=new File("C:\\Users\\Administrator\\Pictures/12.jpg");
		
		try {
			test.resizeFix(f, f2, 100, 100);
		} catch (Exception e) {
